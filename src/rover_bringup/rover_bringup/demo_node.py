...
class DemoPublisher(Node):
    ...
    def front_suspension_callback(self):
        ...
        msg.control_mode = 2
        msg.input_mode = 1
        msg.input_pos = 0.2 * math.sin(self.front_time)
        msg.input_vel = 0.0
    ...
    def middle_suspension_callback(self):
        self.middle_time += 0.1
        msg=ControlMessage()
        msg.control_mode = 2
        msg.input_mode = 1
        msg.input_pos = 0.2 * math.sin(self.middle_time)
        msg.input_vel = 0.0
        msg.input_torque = 0.0
    ...
    def rear_suspension_callback(self):
        ...
        msg.control_mode = 2
        msg.input_mode = 1
        msg.input_pos = 0.2 * math.sin(self.rear_time)
        msg.input_vel = 0.0
        msg.input_torque = 0.0
